...
#include "../PDS_Project/userdata.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UserData_t, stringdata) + ofs \
...
const QMetaObject UserData::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_UserData.data,
      qt_meta_data_UserData,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UserData.stringdata))
